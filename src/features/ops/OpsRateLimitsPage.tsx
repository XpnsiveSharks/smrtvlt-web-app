      ...
      {data && (
        <div className="bg-app-surface-2 rounded-2xl p-8 shadow-2xl shadow-black/40 border border-white/[0.05] relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <div className="bg-app-surface/40 backdrop-blur-md rounded-2xl p-6 border border-white/5 mb-8 shadow-inner group-hover:border-brand/20 transition-colors duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="animate-in fade-in slide-in-from-left-4 duration-700 delay-200 fill-mode-both">
                ...
                {data.top_violators.length === 0 ? (
                  <div className="flex items-center gap-3 bg-app-bg/20 p-4 rounded-xl border border-white/5 text-app-muted italic text-sm">
                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
                    All systems nominal
                  </div>
                ) : (
                  <div className="overflow-hidden rounded-xl border border-white/[0.03] bg-app-bg/10">
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="text-[10px] uppercase tracking-widest text-app-muted bg-white/[0.02]">
                      ...
                      <tbody className="divide-y divide-white/[0.03]">
                        {data.top_violators.map(v => (
                          <tr key={v.key} className="hover:bg-white/[0.04] transition-colors group/row">
